...
pub fn rasterize_needed_tiles<D>(device: &D,
...
pub struct MainToRasterizerMsg {
    tile_request: TileRequest,
    tile_origin: Vector2I,
}

pub enum RasterizerToMainMsg {
    SVGLoaded {
        size: Vector2I,
    },
    TileRasterized {
...
pub fn rasterizer_thread(sender: Sender<RasterizerToMainMsg>,
    ...
    let tile_backing_size = (tile_size + 2) as i32;
